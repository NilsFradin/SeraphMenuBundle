...
// Use the Drupal namespace to facilitate the fork.
    ...
    Drupal.tableDrag.prototype.hideColumns = function () {
        ...
        // Change link text.
        $('.tabledrag-toggle-weight').text('Montrer les champs Parents et Ordre');
        // Change cookie.
        $.cookie('Drupal.tableDrag.showWeight', 0, {
            path: this.tableSettings.cookiePath,
            // The cookie expires in one year.
    ...
    Drupal.tableDrag.prototype.showColumns = function () {
        ...
        // Change link text.
        $('.tabledrag-toggle-weight').text('Cacher les champs Parents et Ordre');
        // Change cookie.
        ...
        if (targetElement) {
            ...
            switch (rowSettings.action) {
                case 'depth':
                    ...
                    targetElement.val($('.indentation', sourceElement.closest('tr')).length + 1);
                    break;
                case 'match':
                    // Update the value.
